...
;; oantolin/embark
;; embark refactoring example workflow is explained below
;; REF https://lambdaland.org/posts/2023-05-31_warp_factor_refactor/
;; (use-package embark
;;   :ensure (:fetcher github :repo "oantolin/embark")
;;   :defer 0.1
;;   :bind
;;   (("C-c a" . embark-act)))
...
;; ;; TODO migrate to cofu
;; (use-package company
;;   :ensure (:fetcher github :repo "company-mode/company-mode")
;;   :defer 0.1
;;   ;; below doesn't work at init
